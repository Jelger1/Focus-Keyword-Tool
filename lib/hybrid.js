 ...
 * geven; Ahrefs weet hoeveel er in de gekozen regio op gezocht wordt en welke
...
export function gscSummary(gsc) {
  ...
  return {
    ...
    // ISO-landcode waarop gefilterd is (nld, usa), of null voor alle landen.
    country: gsc.country ?? null,
  };
}
